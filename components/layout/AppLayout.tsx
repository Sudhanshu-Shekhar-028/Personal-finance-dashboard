  ...
  return (
    <FinanceProvider>
      <div className="flex min-h-screen justify-center lg:p-6 bg-background-primary transition-colors duration-300 dark:bg-[#0F1115] dark:bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] dark:from-[#12151b] dark:to-[#0f1115]">
        <div className="flex w-full max-w-[1440px] bg-background-elevated lg:rounded-3xl lg:shadow-soft-lg overflow-hidden min-h-screen lg:min-h-[calc(100vh-3rem)] border-0 lg:border border-white/50 dark:border-white/5 relative shadow-soft">
